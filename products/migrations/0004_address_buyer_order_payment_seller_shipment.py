...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('products', '0003_auto_20240624_1217'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('default_billing_address', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='buyer_billing_address', to='products.address')),
                ('default_shipping_address', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='buyer_shipping_address', to='products.address')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('amount_paid', djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('0'), default_currency='EUR', max_digits=12)),
